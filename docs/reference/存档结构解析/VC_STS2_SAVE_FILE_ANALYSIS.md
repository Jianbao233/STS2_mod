...
> **数据版本**：基于 v0.99 反编译（2026-03）分析，schema 版本（v2/v21/v14）与当前 v0.110.1 基线**未核对**。
> **归档记录**：2026-08-10 移入 `reference/存档结构解析/`。策略：游戏更新后若发现代码不适用，回到此处重新解析存档结构并更新本文；更新时同步更新本头注。
> 面向制作存档修改工具。
