...
using NSlider = MegaCrit.Sts2.Core.Nodes.GodotExtensions.NSlider;
...
public partial class NConfigSlider : Control
{
    ...
    // NSlider is in MegaCrit.Sts2.Core.Nodes.GodotExtensions in the actual game code
    private MegaCrit.Sts2.Core.Nodes.GodotExtensions.NSlider _slider = null!;
    ...
    public override void _Ready()
    {
        ...
        var label = GetNodeOrNull<MegaRichTextLabel>("SliderValue");
        if (label != null)
        {
